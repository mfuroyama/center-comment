...
const getCommentTypes = language => ({
    multiline: {
        prefix: CommentTypes.multiline.prefix[language] || 'UNKNOWN',
        suffix: CommentTypes.multiline.suffix[language] || 'UNKNOWN',
    },
    singleline: {
        prefix: CommentTypes.singleline.prefix[language] || 'UNKNOWN',
